...
type RadicleMapProps = {
  className?: string;
};

const RadicleMap: FC<RadicleMapProps> = ({ className }) => {
  return (
    <svg className={`${className}`} viewBox="0 0 959 593">
      ...
      >
        <path
          className="al border border-red-500"
        ...
        <path
          className="il transition fill-orange-600"
